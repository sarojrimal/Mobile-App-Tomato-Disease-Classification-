...
import com.example.myapplication.ml.Tomato1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera.setOnClickListener(this::onClick2);
        gallery.setOnClickListener(this::onClick);

    }

    public void classifyImage(Bitmap image){
        try {
            Tomato1 model = Tomato1.newInstance(getApplicationContext());
            ...
            Tomato1.Outputs outputs = model.process(inputFeature0);
